...
import { Moon, XIcon } from "lucide-react";
  ...
  return (
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close className="ring-offset-background flex gap-3 items-center focus:ring-ring absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
          <span className="flex justify-center items-center">
            <Moon className="text-[28px]" />
          </span>
