...
export default function DashboardContent({ setResponse }) {
  ...
  return (
    <div className="min-h-dvh bg-[#080A0F] flex justify-center relative overflow-hidden pt-[88px]">
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-5 px-4 py-10 md:py-16 items-start">
        <div className="bg-white/[0.03] rounded-2xl border border-white/[0.08] p-6 md:p-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <textarea
              ...
              className="bg-white/[0.04] w-full h-32 rounded-xl px-4 py-3 resize-none outline-none border border-white/[0.08] focus:border-sky-500/50 focus:bg-white/[0.06] text-sm text-white placeholder:text-neutral-600"
            />
