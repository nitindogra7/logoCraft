  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex justify-center">
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 px-4 py-10 pt-30 md:pt-30 md:py-16">
        <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-6 md:p-8 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm p-6 md:p-8 flex items-center justify-center">
